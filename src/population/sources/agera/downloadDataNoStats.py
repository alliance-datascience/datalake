...
def download_agera5_data(variable_name, year, month, day, bucket, download_path, zip_name,
                         datalake_zone, source, s3_variable_name, url, key):
...
def main():
    ...
    agera5_args = conf_args[args.confType]
